...
namespace WebSiteBanHang.Controllers
{
    public class QuanLyDonHangController : Controller
    {
        ...
        public ActionResult DuyetDonHang(DonDatHang ddh)
        {
            ...
            ViewBag.ListChiTietDH = lstChiTietDH;
            GuiEmail("Xác nhận đơn hàng","laihuyha@gmail.com", "laihuyha1111@gmail.com", "Ha11122000", "Đơn hàng của bạn đã được đặt thành công");
        ...
        {
            //Gán biến
            FromEmail = "Laihuyha1111@gmail.com";
            PassWord = "Ha11122000";
            // goi email
            ...
            //smtp.Credentials = new NetworkCredential("laihuyha@gmail.com", "Huyha1112", "smtp.gmail.com");
